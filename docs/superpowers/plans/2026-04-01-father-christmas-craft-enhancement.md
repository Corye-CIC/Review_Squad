# Father Christmas Craft Intelligence Enhancement Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Add a `## Craft Intelligence` section to all four FC agents giving FC a named code smell taxonomy, naming precision rules, structure standards, SOLID deep cuts, design pattern intelligence, database query patterns, migration safety, and a REJECT/WARN/NOTE enforcement tier system.

**Architecture:** Create one canonical reference file (`father-christmas-craft.md`) containing the full Craft Intelligence content, then paste it into all four agent files after the role block.
...
| Action | File |
|--------|------|
| Create | `~/Claude/Work/Review_Squad/agents/_shared/father-christmas-craft.md` ✅ already done |
| Create | `~/.claude/agents/father-christmas-craft.md` |
| Modify | `~/.claude/agents/father-christmas-consult.md` |
| Modify | `~/.claude/agents/father-christmas-implement.md` |
| Modify | `~/.claude/agents/father-christmas-review.md` |
| Modify | `~/.claude/agents/father-christmas-audit.md` |
| Sync | `~/Claude/Work/Review_Squad/agents/father-christmas-consult.md` |
| Sync | `~/Claude/Work/Review_Squad/agents/father-christmas-implement.md` |
| Sync | `~/Claude/Work/Review_Squad/agents/father-christmas-review.md` |
| Sync | `~/Claude/Work/Review_Squad/agents/father-christmas-audit.md` |

---

## Craft Intelligence Block

The following block is inserted after the `</role>` closing tag and before `## Mode: X` in every FC agent. This is the canonical content — do not abbreviate, summarise, or rewrite it. Paste verbatim.
...
Copy the content from `~/Claude/Work/Review_Squad/agents/_shared/father-christmas-craft.md` verbatim to `/home/corye/.claude/agents/father-christmas-craft.md`.

- [ ] **Step 2: Verify**

```bash
ls -la /home/corye/.claude/agents/father-christmas-craft.md
```
...
### Task 2: Update father-christmas-consult.md (live)

**Files:**
- Modify: `/home/corye/.claude/agents/father-christmas-consult.md`

- [ ] **Step 1: Read the current file**

Read `/home/corye/.claude/agents/father-christmas-consult.md` and identify the exact line where `## Mode: Consult` appears.
...
### Task 3: Update father-christmas-implement.md (live)

**Files:**
- Modify: `/home/corye/.claude/agents/father-christmas-implement.md`

- [ ] **Step 1: Read the current file**

Read `/home/corye/.claude/agents/father-christmas-implement.md` and identify the exact line where `## Mode: Implement` appears.
...
### Task 4: Update father-christmas-review.md (live)

**Files:**
- Modify: `/home/corye/.claude/agents/father-christmas-review.md`

- [ ] **Step 1: Read the current file**

Read `/home/corye/.claude/agents/father-christmas-review.md` and identify:
...
### Task 5: Update father-christmas-audit.md (live)

**Files:**
- Modify: `/home/corye/.claude/agents/father-christmas-audit.md`

- [ ] **Step 1: Read the current file**

Read `/home/corye/.claude/agents/father-christmas-audit.md` and identify the exact line where `## Mode: Audit` appears.
...
For each of the four FC agents, sync the live `~/.claude/agents/` version back to `~/Claude/Work/Review_Squad/agents/`:

- [ ] Copy `~/.claude/agents/father-christmas-consult.md` → `~/Claude/Work/Review_Squad/agents/father-christmas-consult.md`
- [ ] Copy `~/.claude/agents/father-christmas-implement.md` → `~/Claude/Work/Review_Squad/agents/father-christmas-implement.md`
- [ ] Copy `~/.claude/agents/father-christmas-review.md` → `~/Claude/Work/Review_Squad/agents/father-christmas-review.md`
- [ ] Copy `~/.claude/agents/father-christmas-audit.md` → `~/Claude/Work/Review_Squad/agents/father-christmas-audit.md`

Verify with:
```bash
diff ~/.claude/agents/father-christmas-consult.md ~/Claude/Work/Review_Squad/agents/father-christmas-consult.md
diff ~/.claude/agents/father-christmas-implement.md ~/Claude/Work/Review_Squad/agents/father-christmas-implement.md
diff ~/.claude/agents/father-christmas-review.md ~/Claude/Work/Review_Squad/agents/father-christmas-review.md
diff ~/.claude/agents/father-christmas-audit.md ~/Claude/Work/Review_Squad/agents/father-christmas-audit.md
```
